...
class WebsitesControllerTest < ActionController::TestCase
  ...
  test "should create website" do
    assert_difference('Website.count') do
      post :create, website: { least_reason: @website.least_reason, least_reliable: @website.least_reliable, most_reason: @website.most_reason, most_reliable: @website.most_reliable }
    end
  ...
  test "should update website" do
    put :update, id: @website, website: { least_reason: @website.least_reason, least_reliable: @website.least_reliable, most_reason: @website.most_reason, most_reliable: @website.most_reliable }
    assert_redirected_to website_path(assigns(:website))
  end
